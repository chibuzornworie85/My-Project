      ...
      <div className="footer">
        <div className="footer1">
          <div className="col-2">
            ...
            <ul>
              <li>
                <a href="#About Us" className="nav1">
                  About Us
                </a>
              </li>
              <li>
                <a href="#Contact" className="nav1">
                  Contact
                </a>
              </li>
              <li>
                <a href="#Teams" className="nav1">
                  Teams
                </a>
              </li>
              <li>
                <a href="#Careers" className="nav1">
                  Careers
                </a>
              </li>
              <li>
                <a href="#Blog" className="nav1">
                  Blog
                </a>
              </li>
              <li>
                <a href="#Press" className="nav1">
                  Press
                </a>
              </li>
            </ul>
